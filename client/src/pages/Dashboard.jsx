  ...
  return (
    <div style={{ padding: 8 }}>
      <div className="p-4">
        ...
        <div className="p-2 flex flex-row justify-start items-start gap-1">
          <div className="h-64 w-full md:w-1/3 p-1 bg-slate-50 border border-slate-300 rounded">
          ...
          <div className="h-64 w-full md:w-2/3 p-1 bg-slate-50 border border-slate-300 rounded overflow-y-auto">
            <div className="p-1 text-left text-base font-normal">
              Exchange Rates
            </div>
